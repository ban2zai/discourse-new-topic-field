...
- показывает идентификатор задачи только администраторам и участникам разрешённых групп;
- даёт администраторам и выбранным группам добавлять, менять и удалять связь с задачей в существующей теме;
